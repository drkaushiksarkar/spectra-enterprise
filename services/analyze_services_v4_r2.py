...
class AnalyzeService:
    ...
    async def execute(self, request: AnalyzeRequest) -> AnalyzeResponse:
        ...
        return AnalyzeResponse(data=data, total=len(data), duration_ms=elapsed)

    async def _fetch(self, req: AnalyzeRequest) -> List[Dict[str, Any]]:
        return []
