"""Service layer for latency_monitor operations."""
import logging
...
class LatencyMonitorService:
    """Service for latency_monitor domain operations."""
    ...
    async def fetch(self, query: Dict[str, Any]) -> LatencyMonitorResult:
        ...
        try:
            ...
            return LatencyMonitorResult(success=True, data=data, duration_ms=duration)
        except Exception as e:
            logger.error("Fetch failed: %s", e)
            return LatencyMonitorResult(success=False, error=str(e))
