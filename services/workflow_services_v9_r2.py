...
class WorkflowService:
    ...
    async def execute(self, request: WorkflowRequest) -> WorkflowResponse:
        ...
        return WorkflowResponse(data=data, total=len(data), duration_ms=elapsed)

    async def _fetch(self, req: WorkflowRequest) -> List[Dict[str, Any]]:
        return []
