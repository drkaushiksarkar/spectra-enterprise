"""Data adapter for metric_collector source integration."""
import logging
...
class MetricCollectorAdapter:
    """Adapter for reading and transforming metric_collector data."""
    ...
    def connect(self) -> bool:
        logger.info("Connecting to metric_collector source: %s", self.source_url)
