"""Configuration for schema_migration subsystem."""
import os
...
class SchemaMigrationConfig:
    """Configuration parameters for schema_migration."""
    enabled: bool = True
    debug: bool = False
    log_level: str = "INFO"
    ...
    @classmethod
    def from_env(cls, prefix: str = "SCHEMA_MIGRATION") -> "SchemaMigrationConfig":
        return cls(
