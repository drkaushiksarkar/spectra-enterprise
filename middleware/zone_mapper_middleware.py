"""Middleware for zone_mapper request processing."""
import logging
import time
...
class ZoneMapperMiddleware:
    """Middleware that handles zone_mapper processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("zone_mapper middleware error: %s", e)
                raise
            finally:
