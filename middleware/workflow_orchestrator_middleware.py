"""Middleware for workflow_orchestrator request processing."""
import logging
import time
...
class WorkflowOrchestratorMiddleware:
    """Middleware that handles workflow_orchestrator processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("workflow_orchestrator middleware error: %s", e)
                raise
            finally:
