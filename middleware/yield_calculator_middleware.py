"""Middleware for yield_calculator request processing."""
import logging
import time
...
class YieldCalculatorMiddleware:
    """Middleware that handles yield_calculator processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("yield_calculator middleware error: %s", e)
                raise
            finally:
