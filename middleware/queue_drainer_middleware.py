"""Middleware for queue_drainer request processing."""
import logging
import time
...
class QueueDrainerMiddleware:
    """Middleware that handles queue_drainer processing in the request pipeline."""
    ...
    def __call__(self, handler: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                logger.error("queue_drainer middleware error: %s", e)
                raise
            finally:
