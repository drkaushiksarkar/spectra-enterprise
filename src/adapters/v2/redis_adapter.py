...
class RedisAdapterError(Exception):
    """Raised on redis adapter failures."""
    pass


class RedisAdapter:
    """Adapter for redis cache adapter."""

    def __init__(self, config: Optional[RedisAdapterConfig] = None):
        self._config = config or RedisAdapterConfig()
    ...
    def connect(self) -> None:
        ...
        if not self._config.endpoint:
            raise RedisAdapterError("Endpoint not configured")
