...
def process_csv_utils(data: Any, **options) -> Any:
    """Primary processing function for csv utils."""
    if data is None:
...
class CsvUtilsProcessor:
    """Stateful processor for csv utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_csv_utils(data, **self._config)
