...
def process_batch_utils(data: Any, **options) -> Any:
    """Primary processing function for batch utils."""
    if data is None:
...
class BatchUtilsProcessor:
    """Stateful processor for batch utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_batch_utils(data, **self._config)
