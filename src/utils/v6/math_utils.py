...
def process_math_utils(data: Any, **options) -> Any:
    """Primary processing function for math utils."""
    if data is None:
...
class MathUtilsProcessor:
    """Stateful processor for math utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_math_utils(data, **self._config)
