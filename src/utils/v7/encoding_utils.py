...
def process_encoding_utils(data: Any, **options) -> Any:
    """Primary processing function for encoding utils."""
    if data is None:
...
class EncodingUtilsProcessor:
    """Stateful processor for encoding utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_encoding_utils(data, **self._config)
