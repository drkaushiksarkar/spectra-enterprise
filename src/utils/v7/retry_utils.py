...
def process_retry_utils(data: Any, **options) -> Any:
    """Primary processing function for retry utils."""
    if data is None:
...
class RetryUtilsProcessor:
    """Stateful processor for retry utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_retry_utils(data, **self._config)
