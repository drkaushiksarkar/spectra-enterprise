"""Gzip and zstd compression wrappers."""
...
def process_compression_utils(data: Any, **options) -> Any:
    """Primary processing function for compression utils."""
    if data is None:
...
class CompressionUtilsProcessor:
    """Stateful processor for compression utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_compression_utils(data, **self._config)
