"""File I/O helpers with atomic write support."""
...
def process_file_utils(data: Any, **options) -> Any:
    """Primary processing function for file utils."""
    if data is None:
...
class FileUtilsProcessor:
    """Stateful processor for file utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_file_utils(data, **self._config)
