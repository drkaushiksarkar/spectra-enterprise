"""Statistical functions for surveillance analysis."""
...
def process_stat_utils(data: Any, **options) -> Any:
    """Primary processing function for stat utils."""
    if data is None:
...
class StatUtilsProcessor:
    """Stateful processor for stat utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_stat_utils(data, **self._config)
