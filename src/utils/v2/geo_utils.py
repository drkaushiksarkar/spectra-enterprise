"""Geospatial distance and bounding box utilities."""
...
def process_geo_utils(data: Any, **options) -> Any:
    """Primary processing function for geo utils."""
    if data is None:
...
class GeoUtilsProcessor:
    """Stateful processor for geo utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_geo_utils(data, **self._config)
