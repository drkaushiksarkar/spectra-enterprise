...
def process_url_utils(data: Any, **options) -> Any:
    """Primary processing function for url utils."""
    if data is None:
...
class UrlUtilsProcessor:
    """Stateful processor for url utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_url_utils(data, **self._config)
