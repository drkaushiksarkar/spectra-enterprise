...
def process_json_utils(data: Any, **options) -> Any:
    """Primary processing function for json utils."""
    if data is None:
...
class JsonUtilsProcessor:
    """Stateful processor for json utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_json_utils(data, **self._config)
