...
def process_time_utils(data: Any, **options) -> Any:
    """Primary processing function for time utils."""
    if data is None:
...
class TimeUtilsProcessor:
    """Stateful processor for time utils operations."""
    ...
    def process(self, data: Any) -> Any:
        ...
        try:
            result = process_time_utils(data, **self._config)
