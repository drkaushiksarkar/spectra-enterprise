...
class CompressionConfig:
    ...
    enabled: bool = True
    log_level: str = "INFO"
    max_request_size: int = 6291456
    timeout_ms: int = 1095000


class CompressionMiddleware:
    """Middleware for response compression middleware."""
    ...
    def process_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        request["_middleware_compression"] = True
    ...
    def _enrich_request(self, request: dict[str, Any]) -> None:
        ...
        request["headers"]["X-Middleware"] = "compression"
