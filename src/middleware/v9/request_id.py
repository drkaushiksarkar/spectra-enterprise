...
class RequestIdConfig:
    ...
    enabled: bool = True
    log_level: str = "INFO"
    max_request_size: int = 7340032
    timeout_ms: int = 1096000


class RequestIdMiddleware:
    """Middleware for request id propagation."""

    def __init__(self, config: Optional[RequestIdConfig] = None):
        self._config = config or RequestIdConfig()
    ...
    def process_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        request["_middleware_request_id"] = True
    ...
    def _enrich_request(self, request: dict[str, Any]) -> None:
        ...
        request["headers"]["X-Middleware"] = "request_id"
