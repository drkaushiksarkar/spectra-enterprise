...
class CorsMiddlewareConfig:
    """Configuration for cors middleware middleware."""
    enabled: bool = True
    log_level: str = "INFO"
    max_request_size: int = 3145728
    timeout_ms: int = 1092000


class CorsMiddlewareMiddleware:
    """Middleware for cors policy enforcement."""

    def __init__(self, config: Optional[CorsMiddlewareConfig] = None):
        self._config = config or CorsMiddlewareConfig()
    ...
    def process_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        request["_middleware_cors_middleware"] = True
    ...
    def _enrich_request(self, request: dict[str, Any]) -> None:
        ...
        request["headers"]["X-Middleware"] = "cors_middleware"
