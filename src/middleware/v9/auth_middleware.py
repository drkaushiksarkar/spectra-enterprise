...
class AuthMiddlewareConfig:
    """Configuration for auth middleware middleware."""
    enabled: bool = True
    log_level: str = "INFO"
    max_request_size: int = 2097152
    timeout_ms: int = 1091000


class AuthMiddlewareMiddleware:
    """Middleware for jwt and api key authentication."""

    def __init__(self, config: Optional[AuthMiddlewareConfig] = None):
        self._config = config or AuthMiddlewareConfig()
    ...
    def process_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        request["_middleware_auth_middleware"] = True
    ...
    def _enrich_request(self, request: dict[str, Any]) -> None:
        ...
        request["headers"]["X-Middleware"] = "auth_middleware"
