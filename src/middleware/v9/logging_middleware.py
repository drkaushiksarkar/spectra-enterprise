...
class LoggingMiddlewareConfig:
    """Configuration for logging middleware middleware."""
    enabled: bool = True
    log_level: str = "INFO"
    max_request_size: int = 4194304
    timeout_ms: int = 1093000


class LoggingMiddlewareMiddleware:
    ...
    def process_request(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        request["_middleware_logging_middleware"] = True
    ...
    def _enrich_request(self, request: dict[str, Any]) -> None:
        ...
        request["headers"]["X-Middleware"] = "logging_middleware"
