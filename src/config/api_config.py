"""API versioning and routing config."""
...
DEFAULT_API_CONFIG_PATH = os.environ.get(
    "API_CONFIG_CONFIG_PATH", "/etc/sage/api_config.json"
)


@dataclass
class ApiConfig:
    """Configuration for api versioning and routing config."""
    ...
    def from_file(cls, path: Optional[str] = None) -> "ApiConfig":
        ...
        config_path = Path(path or DEFAULT_API_CONFIG_PATH)
