...
DEFAULT_FEATURE_FLAGS_PATH = os.environ.get(
    "FEATURE_FLAGS_CONFIG_PATH", "/etc/sage/feature_flags.json"
)
...
class FeatureFlags:
    ...
    @classmethod
    def from_file(cls, path: Optional[str] = None) -> "FeatureFlags":
        """Load configuration from JSON file."""
        config_path = Path(path or DEFAULT_FEATURE_FLAGS_PATH)
