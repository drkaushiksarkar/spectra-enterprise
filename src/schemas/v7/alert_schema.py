...
SCHEMA_ALERT_SCHEMA = {
    "type": "object",
    "title": "Alert Schema Schema",
    "description": "Alert payload schema",
    "version": "1.7.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_alert_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against alert_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_ALERT_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_ALERT_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_ALERT_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_ALERT_SCHEMA.get("properties", {}).keys())
