...
SCHEMA_EXPORT_SCHEMA = {
    "type": "object",
    "title": "Export Schema Schema",
...
def validate_export_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against export_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_EXPORT_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_EXPORT_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_EXPORT_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_EXPORT_SCHEMA.get("properties", {}).keys())
