...
SCHEMA_EVENT_SCHEMA = {
    "type": "object",
    "title": "Event Schema Schema",
    "description": "Event bus message schema",
    "version": "2.4.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_event_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against event_schema schema. Returns list of error messages."""
    errors = []
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_EVENT_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_EVENT_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_EVENT_SCHEMA.get("properties", {}).keys())
