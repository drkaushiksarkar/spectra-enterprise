...
SCHEMA_QUALITY_SCHEMA = {
    "type": "object",
    "title": "Quality Schema Schema",
    "description": "Quality report schema",
    "version": "3.8.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_quality_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against quality_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_QUALITY_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_QUALITY_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_QUALITY_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_QUALITY_SCHEMA.get("properties", {}).keys())
