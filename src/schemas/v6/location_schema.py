...
SCHEMA_LOCATION_SCHEMA = {
    "type": "object",
    "title": "Location Schema Schema",
    "description": "Location hierarchy schema",
    "version": "2.1.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_location_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against location_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_LOCATION_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_LOCATION_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_LOCATION_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_LOCATION_SCHEMA.get("properties", {}).keys())
