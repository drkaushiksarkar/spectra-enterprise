...
SCHEMA_FORECAST_SCHEMA = {
    "type": "object",
    "title": "Forecast Schema Schema",
    "description": "Forecast result schema",
    "version": "3.9.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_forecast_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against forecast_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_FORECAST_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_FORECAST_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_FORECAST_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_FORECAST_SCHEMA.get("properties", {}).keys())
