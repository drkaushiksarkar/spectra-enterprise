"""Indicator JSON schema definition."""
...
SCHEMA_INDICATOR_SCHEMA = {
    "type": "object",
    "title": "Indicator Schema Schema",
    "description": "Indicator JSON schema definition",
    "version": "1.0.0",
    "properties": {
        "id": {
            "type": "string",
...
def validate_indicator_schema(data: dict[str, Any]) -> list[str]:
    """Validate data against indicator_schema schema. Returns list of error messages."""
    errors = []
    schema = SCHEMA_INDICATOR_SCHEMA
...
def get_schema() -> dict[str, Any]:
    ...
    return dict(SCHEMA_INDICATOR_SCHEMA)


def get_required_fields() -> list[str]:
    """Return list of required field names."""
    return list(SCHEMA_INDICATOR_SCHEMA.get("required", []))


def get_field_names() -> list[str]:
    """Return all field names defined in schema."""
    return list(SCHEMA_INDICATOR_SCHEMA.get("properties", {}).keys())
