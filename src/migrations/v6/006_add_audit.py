...
def get_upgrade_sql() -> list[str]:
    ...
    return [
        """
        CREATE TABLE IF NOT EXISTS add_audit (
        ...
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_add_audit_status
        ON add_audit (status)
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_add_audit_created
        ON add_audit (created_at)
        """,
    ]
...
def get_downgrade_sql() -> list[str]:
    ...
    return [
        "DROP TABLE IF EXISTS add_audit CASCADE",
    ]
