...
MIGRATION_ID = "008"
MIGRATION_NAME = "008_add_quality"
DESCRIPTION = "Add data quality tracking"
REVERSIBLE = True
...
def get_upgrade_sql() -> list[str]:
    ...
    return [
        """
        CREATE TABLE IF NOT EXISTS add_quality (
        ...
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_add_quality_status
        ON add_quality (status)
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_add_quality_created
        ON add_quality (created_at)
        """,
    ]
...
def get_downgrade_sql() -> list[str]:
    ...
    return [
        "DROP TABLE IF EXISTS add_quality CASCADE",
    ]
